...
[peaks, ind] = findpeaks(removed_data, 'MinPeakHeight', 0.38, 'MinPeakDistance', 5*sampling_frequency);
...
width_s = 0.2; % how long each shoulder shrug last
...
% ADDED - WIDTH_S/2 BECAUSE IT SHOULD BE 0.2 SECONDS CENTERED AROUND THE
% PEAKS, NOT 0.2 SECONDS FOLLOWING THE PEAK
